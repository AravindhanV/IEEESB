...
public class CalendarAdapterEvents extends RecyclerView.Adapter<CalendarAdapterEvents.ViewHolder> {

    ArrayList<CalendarItem> events;
    private Context context;

    public CalendarAdapterEvents(ArrayList<CalendarItem> events, Context context){
        this.events = events;
    ...
    @NonNull
    @Override
    public CalendarAdapterEvents.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.calender_item,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final CalendarAdapterEvents.ViewHolder viewHolder, final int i) {
